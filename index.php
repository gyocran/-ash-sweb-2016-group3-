<html>
	...
	<body>
		...
		<!--This creates the form in which the user enter the details-->
				<div>
					<input type="button-add" onClick="location.href='addbooking.php' " value="Add New Booking" style="float:right">						
				</div>
				...
				<td bgcolor= #ffff66 width=3.5%> <a href = 'editbooking.php?booking_id={$row["booking_id"]}' ><img src='images/pencil.jpg' alt='edit' style='width:80%; height:45%;'> </a> </td>
				<td bgcolor= #ffff66 width=3.5%> <a href = 'deletebooking.php?booking_id={$row["booking_id"]}&user_id={$row["user_id"]}' ><img src='images/delete.jpg' alt='delete' style='width:75%; height:15%;'></a></td>  
				</tr>";	
								}
				...
				<td width=3.5%> <a href = 'editbooking.php?booking_id={$row["booking_id"]}' ><img src='images/pencil.jpg' alt='edit' style='width:80%; height:45%;'> </a> </td>
				<td width=3.5%> <a href = 'deletebooking.php?booking_id={$row["booking_id"]}&user_id={$row["user_id"]}' ><img src='images/delete.jpg' alt='delete' style='width:75%; height:15%;'></a></td>  
				</tr>";	
								}
							$counter++;
							$row = $book ->fetch();
