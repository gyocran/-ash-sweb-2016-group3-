...
INSERT INTO `sweb_booking` (`booking_id`,`user_id`,`org_name`,`event_name`,`event_description`,`labname`,`bookingdate`,`bookingtime`) VALUES (2,1,'pencils of promise','mentoring kids','we will discuss how we can build the capacities of pupils in ayim primary\',\'englab','englab','2016-03-22','8:00-9:00 am');
